...
class ProductsSpecmaticFullRefreshTest(SpecmaticIntegrationTestCase):
    """
    Specmatic-backed integration tests for GET /v1/products.
    ...
    def test_given_one_page_when_read_then_return_records(self) -> None:
        ...
        self.set_specmatic_expectation(
            ...
            response_body={
                ...
                "has_more": False,
                "data": [
                    {"id": "prod_1", "object": "product", "created": int(start_date.timestamp())},
                    {"id": "prod_2", "object": "product", "created": int(start_date.timestamp())},
                ],
            },
        )
    ...
    def test_given_many_pages_when_read_then_return_all_records(self) -> None:
        ...
        self.set_specmatic_expectation(
            ...
            response_body={
                ...
                "url": "/v1/products",
                "has_more": True,
                "data": [{"id": "last_record_id_from_first_page", "object": "product", "created": int(start_date.timestamp())}],
            },
        )
    ...
    def test_given_empty_response_when_read_then_return_no_records(self) -> None:
        ...
        self.set_specmatic_expectation(
            path="/v1/products",
            query={"created[gte]": str(int(start_date.timestamp())), "created[lte]": str(int(now.timestamp())), "limit": "100"},
            response_body={"object": "list", "url": "/v1/products", "has_more": False, "data": []},
        )
