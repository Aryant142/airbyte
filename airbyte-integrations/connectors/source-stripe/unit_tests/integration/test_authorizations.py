                ...
                [
                    {"status_code": 500},
                    {
                        ...
                        "json": {
                            ...
                            "has_more": False,
                            "data": [
                                {"id": "auth_1", "object": "issuing.authorization", "created": int(_NOW_IMPORT.timestamp())}
                            ]
                        }
                    }
                ]
    ...
    def test_given_no_state_when_read_then_use_authorizations_endpoint(self) -> None:
        ...
        self.set_specmatic_expectation(
            ...
            response_body={
                ...
                "has_more": False,
                "data": [
                    {"id": "auth_1", "object": "issuing.authorization", "created": cursor_value}
                ]
            }
        )
                ...
                "data": [
                    {
                        ...
                        "data": {
                            "object": {"id": "auth_1", "object": "issuing.authorization", "created": cursor_value}
                        }
                    }
                ]
            }
                ...
                "data": [
                    {
                        ...
                        "created": cursor_value,
                        "data": {
                            "object": {"id": "auth_2", "object": "issuing.authorization", "created": cursor_value}
                        }
                    }
                ]
            }
            ...
            response_body={
                ...
                "data": [
                    ...
                    },
                    {
                        ...
                        "created": cursor_value,
                        "data": {
                            "object": {"id": "auth_3", "object": "issuing.authorization", "created": cursor_value}
                        }
                    }
                ]
            }
