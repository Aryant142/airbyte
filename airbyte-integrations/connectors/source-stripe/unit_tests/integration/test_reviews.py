...
class FullRefreshTest(SpecmaticIntegrationTestCase):
    ...
    def test_given_one_page_when_read_then_return_records(self) -> None:
        ...
        self.set_specmatic_expectation(
            ...
            response_body={
                ...
                "has_more": False,
                "data": [
                    {"id": "prv_1", "object": "review", "created": int(start_date.timestamp())},
                    {"id": "prv_2", "object": "review", "created": int(start_date.timestamp())}
                ]
            }
        )
    ...
    def test_given_many_pages_when_read_then_return_records(self) -> None:
        ...
        self.set_specmatic_expectation(
            ...
            response_body={
                ...
                "has_more": True,
                "data": [
                    {"id": "last_record_id_from_first_page", "object": "review", "created": int(start_date.timestamp())}
                ]
            }
        )
    ...
    def test_given_http_status_400_when_read_then_stream_did_not_run(self) -> None:
        url = f"{_CONFIG['url_base']}reviews"
        with requests_mock.Mocker(real_http=True) as m:
            m.register_uri("GET", url, status_code=400, json={"error": {"message": "Bad request"}})
            self.source = get_source(_CONFIG, _NO_STATE)
    ...
    def test_given_http_status_401_when_read_then_config_error(self) -> None:
        url = f"{_CONFIG['url_base']}reviews"
        with requests_mock.Mocker(real_http=True) as m:
            m.register_uri("GET", url, status_code=401, json={"error": {"message": "Unauthorized"}})
            self.source = get_source(_CONFIG, _NO_STATE)
                ...
                [
                    {"status_code": 500},
                    {
                        ...
                        "json": {
                            ...
                            "has_more": False,
                            "data": [
                                {"id": "prv_1", "object": "review", "created": int(_NOW_IMPORT.timestamp())}
                            ]
                        }
                    }
                ]
    ...
    def test_given_no_state_when_read_then_use_reviews_endpoint(self) -> None:
        ...
        self.set_specmatic_expectation(
            ...
            response_body={
                ...
                "has_more": False,
                "data": [
                    {"id": "prv_1", "object": "review", "created": cursor_value}
                ]
            }
        )
        self.source = get_source(_CONFIG, _NO_STATE)
                ...
                "data": [
                    {
                        ...
                        "data": {
                            "object": {"id": "prv_1", "object": "review", "created": cursor_value}
                        }
                    }
                ]
            }
                ...
                "data": [
                    {
                        ...
                        "created": cursor_value,
                        "data": {
                            "object": {"id": "prv_2", "object": "review", "created": cursor_value}
                        }
                    }
                ]
            }
