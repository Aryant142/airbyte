...
class FullRefreshTest(SpecmaticIntegrationTestCase):
    ...
    def test_given_no_state_when_read_then_return_ignore_lookback(self) -> None:
        ...
        self.set_specmatic_expectation(
            ...
            response_body={
                ...
                "url": "/v1/application_fees",
                "has_more": False,
                "data": [{"id": "fee_1", "object": "application_fee", "created": int(start_date.timestamp())}],
            },
        )
    ...
    def test_given_http_status_400_when_read_then_stream_incomplete(self) -> None:
        now, _ = get_dates()
        url = f"{_CONFIG['url_base']}application_fees"
                ...
                [
                    {"status_code": 500},
                    {
                        ...
                        "json": {
                            ...
                            "url": "/v1/application_fees",
                            "has_more": False,
                            "data": [{"id": "fee_1", "object": "application_fee", "created": int(_NOW_IMPORT.timestamp())}],
                        },
                    },
                ],
            )
    ...
    def test_given_no_state_when_read_then_use_application_fees_endpoint(self) -> None:
        ...
        self.set_specmatic_expectation(
            ...
            response_body={
                ...
                "url": "/v1/application_fees",
                "has_more": False,
                "data": [{"id": "fee_1", "object": "application_fee", "created": cursor_value}],
            },
        )
                ...
                "data": [
                    {
                        ...
                        "data": {"object": {"id": "fee_1", "object": "application_fee", "created": cursor_value}},
                    }
                ],
            },
        )
                ...
                "data": [
                    {
                        ...
                        "object": "event",
                        "created": cursor_value,
                        "data": {"object": {"id": "fee_2", "object": "application_fee", "created": cursor_value}},
                    }
                ],
            },
        )
            ...
            response_body={
                ...
                "data": [
                    ...
                    },
                    {
                        ...
                        "object": "event",
                        "created": cursor_value,
                        "data": {"object": {"id": "fee_3", "object": "application_fee", "created": cursor_value}},
                    },
                ],
            },
        )
