...
class PricesSpecmaticFullRefreshTest(SpecmaticIntegrationTestCase):
    ...
    def test_given_one_page_when_read_then_return_records(self) -> None:
        ...
        self.set_specmatic_expectation(
            ...
            response_body={
                ...
                "has_more": False,
                "data": [
                    {"id": "price_1", "object": "price", "created": int(start_date.timestamp())},
                    {"id": "price_2", "object": "price", "created": int(start_date.timestamp())},
                ],
            },
        )
    ...
    def test_given_many_pages_when_read_then_return_all_records(self) -> None:
        ...
        self.set_specmatic_expectation(
            ...
            response_body={
                ...
                "url": "/v1/prices",
                "has_more": True,
                "data": [{"id": "last_record_id_from_first_page", "object": "price", "created": int(start_date.timestamp())}],
            },
        )
    ...
    def test_given_empty_response_when_read_then_return_no_records(self) -> None:
        ...
        self.set_specmatic_expectation(
            path="/v1/prices",
            query={"created[gte]": str(int(start_date.timestamp())), "created[lte]": str(int(now.timestamp())), "limit": "100"},
            response_body={"object": "list", "url": "/v1/prices", "has_more": False, "data": []},
        )
