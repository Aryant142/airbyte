    ...
    def test_given_many_pages_when_read_then_return_records(self) -> None:
        ...
        self.set_specmatic_expectation(
            ...
            response_body={
                ...
                "has_more": True,
                "data": [
                    {"id": "last_record_id_from_first_page", "object": "issuing.card", "created": int(start_date.timestamp())}
                ]
            }
        )
                ...
                [
                    {"status_code": 500},
                    {
                        ...
                        "json": {
                            ...
                            "has_more": False,
                            "data": [
                                {"id": "card_1", "object": "issuing.card", "created": int(_NOW_IMPORT.timestamp())}
                            ]
                        }
                    }
                ]
    ...
    def test_given_no_state_when_read_then_use_cards_endpoint(self) -> None:
        ...
        self.set_specmatic_expectation(
            ...
            response_body={
                ...
                "has_more": False,
                "data": [
                    {"id": "card_1", "object": "issuing.card", "created": cursor_value}
                ]
            }
        )
                ...
                "data": [
                    {
                        ...
                        "data": {
                            "object": {"id": "card_1", "object": "issuing.card", "created": cursor_value}
                        }
                    }
                ]
            }
                ...
                "data": [
                    {
                        ...
                        "created": cursor_value,
                        "data": {
                            "object": {"id": "card_2", "object": "issuing.card", "created": cursor_value}
                        }
                    }
                ]
            }
            ...
            response_body={
                ...
                "data": [
                    ...
                    },
                    {
                        ...
                        "created": cursor_value,
                        "data": {
                            "object": {"id": "card_3", "object": "issuing.card", "created": cursor_value}
                        }
                    }
                ]
            }
