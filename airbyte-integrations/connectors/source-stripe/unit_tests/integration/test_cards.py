...
class FullRefreshTest(SpecmaticIntegrationTestCase):
    ...
    def test_given_one_page_when_read_then_return_records(self) -> None:
        ...
        self.set_specmatic_expectation(
            ...
            response_body={
                ...
                "has_more": False,
                "data": [
                    {"id": "card_1", "object": "issuing.card", "created": int(start_date.timestamp())},
                    {"id": "card_2", "object": "issuing.card", "created": int(start_date.timestamp())},
                ],
            },
        )
    ...
    def test_given_many_pages_when_read_then_return_records(self) -> None:
        ...
        self.set_specmatic_expectation(
            ...
            response_body={
                ...
                "url": "/v1/issuing/cards",
                "has_more": True,
                "data": [{"id": "last_record_id_from_first_page", "object": "issuing.card", "created": int(start_date.timestamp())}],
            },
        )
    ...
    def test_given_no_state_when_read_then_return_ignore_lookback(self) -> None:
        ...
        self.set_specmatic_expectation(
            ...
            response_body={
                ...
                "url": "/v1/issuing/cards",
                "has_more": False,
                "data": [{"id": "card_1", "object": "issuing.card", "created": int(start_date.timestamp())}],
            },
        )
    ...
    def test_given_slice_range_when_read_then_perform_multiple_requests(self) -> None:
        ...
        self.set_specmatic_expectation(
            ...
            response_body={"object": "list", "url": "/v1/issuing/cards", "has_more": False, "data": []},
        )
    ...
    def test_given_http_status_400_when_read_then_stream_did_not_run(self) -> None:
        now, _ = get_dates()
        url = f"{_CONFIG['url_base']}issuing/cards"
                ...
                [
                    {"status_code": 500},
                    {
                        ...
                        "json": {
                            ...
                            "url": "/v1/issuing/cards",
                            "has_more": False,
                            "data": [{"id": "card_1", "object": "issuing.card", "created": int(_NOW_IMPORT.timestamp())}],
                        },
                    },
                ],
            )
...
class IncrementalTest(SpecmaticIntegrationTestCase):
    ...
    def test_given_no_state_when_read_then_use_cards_endpoint(self) -> None:
        now, start_date = get_dates()
        ...
        self.set_specmatic_expectation(
            ...
            response_body={
                ...
                "url": "/v1/issuing/cards",
                "has_more": False,
                "data": [{"id": "card_1", "object": "issuing.card", "created": cursor_value}],
            },
        )
                ...
                "data": [
                    {
                        ...
                        "data": {"object": {"id": "card_1", "object": "issuing.card", "created": cursor_value}},
                    }
                ],
            },
        )
                ...
                "data": [
                    {
                        ...
                        "object": "event",
                        "created": cursor_value,
                        "data": {"object": {"id": "card_2", "object": "issuing.card", "created": cursor_value}},
                    }
                ],
            },
        )
            ...
            response_body={
                ...
                "data": [
                    ...
                    },
                    {
                        ...
                        "object": "event",
                        "created": cursor_value,
                        "data": {"object": {"id": "card_3", "object": "issuing.card", "created": cursor_value}},
                    },
                ],
            },
        )
